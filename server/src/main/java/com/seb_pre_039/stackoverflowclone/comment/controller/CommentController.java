...
public class CommentController {
    ...
    public ResponseEntity postComment(@Valid @RequestBody CommentDto.Post post){
        Comment createdComment = commentService.createComment(mapper.commentPostToComment(post));

        return new ResponseEntity<>(mapper.commentToCommentResponse(createdComment), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity patchComment(@PathVariable("comment-id") int commentId,
        ...
        Comment updatedComment = commentService.updateComment(mapper.commentPatchToComment(patch));

        return new ResponseEntity<>(mapper.commentToCommentResponse(updatedComment), HttpStatus.OK);
    }
    ...
    public ResponseEntity getComment(@PathVariable("comment-id") int commentId) {
        ...
        return new ResponseEntity<>(mapper.commentToCommentResponse(findComment), HttpStatus.OK);
    }
//
//    @GetMapping
